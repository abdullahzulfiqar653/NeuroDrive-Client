...
//   { url: string; key: string }, // Input arguments
//   { rejectValue: { error: string } } // Rejected payload
// >('api/fetchData', async ({ url }, { rejectWithValue }) => {
//   try {
//     const response = await apiClient.get(url, getTokenIncludedConfig());
...
//         state.calls[key] = {
//           isLoading: false,
//           error: (typeof action.payload === 'string' || action.payload === null || action.payload === undefined) ? action.payload : 'Unkown Error',
//           response: null,
//         };
//       })
//       // Post Data
