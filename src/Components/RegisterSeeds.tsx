      ...
      <div className="flex flex-col w-[100vw] md:w-[40vw] p-4">
        ...
        <div className="flex flex-col items-center justify-center h-full w-full gap-[5vh]">
          ...
          <div className="relative w-[38vw]">
            ...
            <div className="flex flex-wrap font-sans gap-4 mt-2 justify-between items-center w-full text-xs md:text-sm">
              <p className="text-[#BABABACC] flex-1 min-w-[150px]">
...
//               <p
//                 onClick={handleSave}
//                 className="text-[#000000A1] flex gap-1 items-center cursor-pointer"
//               >
...
//         </div>
//         {saveAlert && (
//           <div className="mt-2 text-green-500">Seeds saved successfully!</div>
//         )}
